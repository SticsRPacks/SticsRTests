...
path_to_JavaStics="D:/OneDrive - cirad.fr/Travail_Postdoc/SticsRPacks"   # A CHANGER POUR DOWNLOAD DEPUIS GOOGLEDRIVE
javastics_path=file.path(path_to_JavaStics,"JavaSTICS-1.41-stics-9.1")
